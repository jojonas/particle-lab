...
\begin{figure}
	...
	\caption{Repeated measurements of the resolution curve (\isotope[60]{Co}). Left: Before and after the measurement with the polyethylene sample. Right: Before and after the measurement with the aluminum sample.}
