...
\end{equation}
This result is not compatible with the literature value of $\SI{2.085 +- 0.042}{\giga\electronvolt}$, and additionally has a smaller uncertainty. This is probably due to neglecting the quark mixing, which would allow additional decays, such as $\PW \rightarrow \Pup + \APstrange$. TODO: Sicher ???
