...
Although the determined results are compatible within their uncertainties, a combination is not trivial. As illustrated in figure \ref{fig:corr}.


\begin{figure}
	\centering
	\includegraphics{chisquare_el_e_t}
	\caption{Scatter plot of the electron transverse energy vs. transverse mass to illustrate the correlation between these quantities.}
	\label{fig:corr}
\end{figure}
