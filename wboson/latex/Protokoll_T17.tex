...
As a measure for the agreement between the data points and the MC-dataset for one given W-mass, the $\chi^2$ is calculated and stored. In some cases, the discrepancy or agreement can even be 	 
